...
# File NAME : C:\FLOWORK\flowork-gateway\app\routes\capsules.py total lines 64 
########################################################################
...
def api_capsules_fac_preview(capsule_id: str):
    """
    (English Hardcode) Body JSON expects: {"user":{"id":...}, "engine":{"id":...,"owner_id":...}}
    (English Hardcode) Returns a FAC as would be rendered for the given user/engine.
    """
    req: Dict[str, Any] = request.get_json(force=True, silent=False) or {}
