...
# File NAME : C:\FLOWORK\flowork-gateway\app\security\env_guard.py total lines 92 
########################################################################
...
def guard_runtime() -> Dict[str, Any]:
    """
    (English Hardcode) R9.2: Call this early at app startup.
    (English Hardcode) - Blocks empty/weak defaults for critical secrets
    (English Hardcode) - Enforces production defaults
    (English Hardcode) - Validates CORS/Origins & Public URL when ENV=production
    (English Hardcode) Returns a summary dict (safe to log).
    """
