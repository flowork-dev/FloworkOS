    ...
    if not regular_user:
        ...
        if not full_private_key:
            ...
            try:
                ...
                new_private_key_hex = full_private_key[2:] # (English Hardcode) Already hex
            except Exception as e:
        ...
        full_private_key = f"0x{new_private_key_hex}" # (English Hardcode) Ensure this is the final key
