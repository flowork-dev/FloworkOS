...
# File NAME : C:\FLOWORK\plugins\agent_host\processor.py total lines 123 
########################################################################
...
class Processor:
    """
    (Refactor R4)
    Sekarang, processor ini bertanggung jawab untuk:
    1. Mem-boot AgentContext (BIOS R3)
    2. Menjalankan validasi FacEnforcer (R4)
    3. Meng-inject wrapped tools (R4) ke LLM
    """
