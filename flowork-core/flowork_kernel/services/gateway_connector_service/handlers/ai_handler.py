...
# File NAME : C:\ORGINAL\flowork-core\flowork_kernel\services\gateway_connector_service\handlers\ai_handler.py total lines 281 
########################################################################
...
class AIHandler(BaseHandler):
    def register_events(self):
        ...
        async def start_training_job(data):
            ...
            job_response = None
            try:
                training_service = self.service.kernel_services.get("ai_training_service")
                if training_service:
