...
# File NAME : C:\ORGINAL\flowork-core\flowork_kernel\services\gateway_connector_service\handlers\data_handler.py total lines 383 
########################################################################
...
class DataHandler(BaseHandler):
    def register_events(self):
        ...
        async def request_datasets_list(data):
            ...
            error_msg = None
            try:
                dataset_manager = self.service.kernel_services.get("dataset_manager_service")
                if dataset_manager:
