...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\model_converter_service\model_converter_service.py total lines 136 
########################################################################
...
class ModelConverterService(BaseService):
    ...
    def _conversion_worker(self, job_id, source_model_folder, output_gguf_name, quantize_method):
        ...
        try:
            ...
            output_folder = self.kernel.ai_models_path
