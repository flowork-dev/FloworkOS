...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\recorder_routes.py total lines 71 
########################################################################
...
class RecorderRoutes(BaseApiRoute):
    """
    Manages API routes for the screen recorder service.
    """
