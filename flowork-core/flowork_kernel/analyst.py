...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\analyst.py total lines 122 
########################################################################
...
class AnalystReport:
    """(R5) Immutable DTO for analysis results."""
...
class Analyst:
    """
    (R5)
    Consumes recent timeline tail (list of events) and produces:
     - stats: gas_used, http_fetch/fs_read counts, episodic r/w, duration, killed flag
     - tags: coarse descriptors (network-heavy, io-heavy, memory-write, efficient/expensive)
     - risks: red flags (out_of_gas, frequent_errors, high_io)
    Keep it rule-based and deterministic to stay lightweight.
    """
