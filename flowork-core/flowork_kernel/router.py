...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\router.py total lines 26 
########################################################################
...
class StrategyRouter:
    """
    (R5) Simple strategy picker.
    - If 'force_strategy' exists in context -> return it.
    - Else random choice among configured strategies.
    Future: can be upgraded to epsilon-greedy / bandit without breaking the contract.
    """
