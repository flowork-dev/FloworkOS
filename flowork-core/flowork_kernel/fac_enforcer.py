...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\fac_enforcer.py total lines 146 
########################################################################
...
class FacRuntime:
    ...
    def _serialize_for_signing(self) -> bytes:
        """ (English Hardcode) Serialize FAC for signature verification. """
    ...
    def _verify_signature(self) -> bool:
        """ (English Hardcode) Verifies the FAC signature. """
    ...
    def _validate_ttl(self, max_ttl_seconds: int = 7200) -> None:
        """ (English Hardcode) Validates the FAC expiration. """
        now = time.time()
    ...
    def _cost_for(self, cap_name: str, size_bytes: int = 0) -> int:
        """ (English Hardcode) Calculate cost for a capability call. """
    ...
    def permit_run_engine(self, engine_id_to_run: str) -> None:
        """
        (English Hardcode) R7 - Checks if the FAC permits running the specified engine_id.
        """
